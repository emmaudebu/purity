<?php
/*
Plugin Name: StreamTube Pro Developer
Plugin URI: https://festingervault.com/p/streams-for-tube-pro-developer/
Version: 2.4.2
Description: Display videos effortlessly! StreamTube Pro Developer lets you create fully custom video feeds on your site. Engage visitors now!
...
StreamTube Pro Developer available through Festinger Vault is an independent version maintained by our team. We are not affiliated, endorsed, or associated with Feeds for YouTube Pro Developer or Smash Balloon in any way. Our support is exclusively for the forked version available in Festinger Vault. If you require official updates, premium features, or priority support from the original developers, we strongly recommend purchasing a valid license from them.
*/
